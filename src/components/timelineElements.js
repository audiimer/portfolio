let timelineElements = [
  ...
  },
  {
    ...
    icon: "school",
    url: "https://certopus.com/c/a3cdfa9bdf6845bc836d3966c551c1b3",
  },
  {
    id: 6,
    title: "Inbound Vendor Receive / Customer Returns",
    location: "Amazon.com | Easton, PA",
    description:
      "Maintained high productivity by consistently processing over 1,000 items daily. Ensured secure and organized packing to support customer satisfaction. Handled returns and replacements of damaged or mislabeled products, contributing to improved warehouse quality and procedures.",
    buttonText: "Company Website",
  ...
  },
  {
    ...
    description:
      "Planned and led high-traffic sales events (weekends, seasonal clearance, promotions) to help meet daily revenue goals of $80K–$100K. Implemented hazard monitoring protocols, preventing accidents and saving the company $10K per incident. Resolved system issues in real time, ensuring minimal disruption and adherence to operating procedures. Recognized for outstanding performance with three promotions: from Cashier to Hardlines Merchandiser, then to Checkout Supervisor, and ultimately to Sales Floor Supervisor.",
